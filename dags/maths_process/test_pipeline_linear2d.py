...
MAX_LINES = 100000
final_result_file = "../algebra__linear_2d.jsonl"
    ...
    for i in range(start_line, len(lines), batch_size):
        try:
            ...
            if len(processed_lines) != 0:
                save_lines(processed_lines,f"../algebra__linear_2d_sol{i}.txt")
...
if __name__ == "__main__":
    input_file = '../algebra__linear_2d.txt'  # Update with your input file path
